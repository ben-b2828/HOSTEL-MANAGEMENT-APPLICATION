...
class HostelApp:
    ...
    def setup_ui(self):
        ...
        tk.Button(self.root, text="Add Student", command=self.add_student,
                  bg="orange", fg="blue").pack(pady=12)
    ...
    def add_student(self):
        ...
        add_win.configure(bg="blue")

        tk.Label(add_win, text="Name:", bg="lightgreen", fg="blue").pack()
        name_entry = tk.Entry(add_win)
        name_entry.pack()

        tk.Label(add_win, text="Age:", bg="lightgreen", fg="blue").pack()
        age_entry = tk.Entry(add_win)
        age_entry.pack()

        tk.Label(add_win, text="Room Number:", bg="lightgreen", fg="blue").pack()
        ...
        tk.Button(add_win, text="Save", command=save_student,
                  bg="lightgreen", fg="blue").pack(pady=10)
    ...
    def manage_payments(self):
        ...
        pay_win.configure(bg="lightgreen")

        tk.Label(pay_win, text="Select Student:", bg="lightgreen", fg="blue").pack()
        ...
        tk.Label(pay_win, text="Payment Amount:", bg="lightgreen", fg="blue").pack()
    ...
    def remove_student(self):
        ...
        remove_win.configure(bg="lightgreen")

        tk.Label(remove_win, text="Select Student to Remove:", bg="lightgreen", fg="blue").pack(pady=5)
        ...
        tk.Button(remove_win, text="Remove", command=confirm_removal,
                  bg="lightgreen", fg="red").pack(pady=10)
